...
describe('Posting blogs', () => {
  ...
  test('Posting to /api/blogs with invalid token', async () => {
    ...
    const response = await api
      ...
      .set(
        'Authorization',
        'bearer eyJhbGciOiJIUzI1NiIsIR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InJvb3QiLCJpZCI6IjYyYzE1MWRmZDA4MzBjZWJkYTQ0Y2Q5YSIsImlhdCI6MTY1NjgzNjU3N30.oiRLJSw56RptbUGSiyzBaS-H4WfrP7OYwZkS4A6FXm'
      )
      .send(newBlog)
      .expect(401)
      .expect('Content-Type', /application\/json/)
